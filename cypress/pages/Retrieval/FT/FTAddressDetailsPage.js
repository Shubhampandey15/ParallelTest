class FTAddressDetailsPage {
    elements = {
        ...
        //commintmentDate
        commitmentDateButton: () => cy.xpath("//span[./text()='Commitment Date']/parent::button"),
        commitmentDateCalendarButton: () => cy.xpath("//input[@placeholder='Date']/following-sibling::button"),
        commitmentDate: (date) => cy.xpath("//a[./text()='" + date + "']"),
        submitComDateButton: () => cy.xpath("(//span[./text()='Submit']/parent::button)[2]"),
        commitmentDateTextbox: () => cy.xpath("//input[@placeholder='Date']"),
        commitmentDateThreeDotOptionButton: () => cy.xpath("//span[./text()='Commitment Date']/parent::button[not(@disabled)]"),
        ...
        // Export 
        exportButtonFTGrid: () => cy.xpath("//span[./text()='Export All']/parent::button"),
        exportButtonFTUsers: () => cy.xpath("(//span[./text()='Export All']/parent::button)[1]"),
        exportButtonFTAppointments: () => cy.xpath("(//span[./text()='Export All']/parent::button)[2]"),
    ...
    verifyCurrentCommentAndTimeStampInTimeSpan(comment) {
        ...
        this.elements.recentCommentTimeStampInTimeLine().then(($obj) => {
            ...
            const str1 = $obj.text()
            expect(str1).to.include(dateAndTime)
    ...
    //commintmentDate
    clickOnCommitmentDateButton() {
        this.elements.commitmentDateButton().click()
    }

    clickOnCommitmentDateExpandCalendarButton() {
        this.elements.commitmentDateCalendarButton().click()
    }
    selectTodayCommitmentDate() {
        var currentDate = new Date()
        var day = currentDate.getDate()
        this.elements.commitmentDate(day).click()

    }
    clickOncommitmentDateSubmitButton() {
        this.elements.submitComDateButton().click()
    }
    clickOnCommitmentDateThreeDotOptionButton() {
        this.elements.commitmentDateThreeDotOptionButton().click()
    }
    verifyCommitmentDate() {
        cy.wait(2000)
        this.elements.commitmentDateTextbox().then(($obj) => {
            const d = new Date();
    ...
    enterAccessInformation(adminContact, adminPhone, itContact, itPhone, emrSystem, editNotes) {
        ...
        this.elements.itPhoneNumberTextbox().clear().type('{SelectALL}{BackSpace}')
    ...
    verifyUploadedFileLabel() {
        ...
        this.elements.divLabel(fileName).scrollIntoView()
    ...
    clickOnExportAllButtonOnFTGrid() {
        this.elements.exportButtonFTGrid().click()
    }
    clickOnExportAllButtonOnFTUsersScheduleTab() {
        this.elements.exportButtonFTUsers().click()
    }
    clickOnExportAllButtonOnFTAppointmentsScheduleTab() {
        this.elements.exportButtonFTAppointments().scrollIntoView().click()
    }
    //
    uploadPDFFileForAccessInformation() {
        const fileName = 'test-pdf-upload.pdf'
...
module.exports = new FTAddressDetailsPage()
