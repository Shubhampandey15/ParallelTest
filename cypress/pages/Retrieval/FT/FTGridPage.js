class FTGridPage
{
    elements = { 
        ...
        ftUsersGrid: () => cy.xpath("//h3[./text()='Field Tech Scheduling USERS']/parent::div/following-sibling::app-basic-grid"), 
        ftAppointmentsGrid: () => cy.xpath("//h3[./text()='Field Tech Scheduling APPOINTMENTS']/following-sibling::app-server-grid"), 
        gridAID:(entryCountNumber) => cy.xpath("(//td[contains(@class, 'masterDocumentSourceID')]/a)["+entryCountNumber+"]"), // click
        gridThreeDotButton:(entryCountNumber) => cy.xpath("(//td[contains(@class, 'ng-star-inserted')]/app-button/p-button/button)["+entryCountNumber+"]"), // click
    ...
    verifyftUsersGrid()
    {
        this.elements.ftUsersGrid().should("be.visible")
    }
    verifyftAppointmentGrid()
    {
        this.elements.ftAppointmentsGrid().scrollIntoView()
        this.elements.ftAppointmentsGrid().should("be.visible")
    }
