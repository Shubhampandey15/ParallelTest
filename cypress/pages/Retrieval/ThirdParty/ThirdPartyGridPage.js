class ThirdPartyGridPage
{
    elements = {        
        ...
        assignedAddressThreeDotButton: () => cy.xpath("(//span[./text()='Assign Addresses']/parent::button)[2]"), //Click
        assignedAddressButtonForGrid: () => cy.xpath("(//span[./text()='Assign Addresses']/parent::button)[1]"), //Click
        ...
        gridPSRAIDCheckbox:(entryCountNumber) => cy.xpath("(//p-tablecheckbox)["+entryCountNumber+"]"), // click
        selectProjectlabel: ()=> cy.xpath("//ul//li[3]//span[contains(text(),'Project(s)')]"),
        selectProject:(projectName)=> cy.xpath("//span[contains(text(),'"+projectName+"')]"),
        runQueryButton:()=> cy.xpath("//span[contains(text(),'Run Query')]"),
        gridAID:(entryCountNumber) => cy.xpath("(//td[contains(@class, 'masterDocumentSourceID')]/a)["+entryCountNumber+"]"), // click
        gridThreeDotButton:(entryCountNumber) => cy.xpath("(//td[contains(@class, 'ng-star-inserted')]/app-button/p-button/button)["+entryCountNumber+"]"), // click
        gridPSRAIDCheckbox:(entryCountNumber) => cy.xpath("(//p-tablecheckbox)["+entryCountNumber+"]"), // click
        gridPSRAIDCheckbox:(entryCountNumber) => cy.xpath("(//p-tablecheckbox)["+entryCountNumber+"]"), // click
    ...
    clickOnThirdPartyAIDCheckbox(entryCountNumber)
    {
    ...
    clickOnProjectNamelabelFilter(){
        this.elements.selectProjectlabel().click()
    }
    clickOnProjectName(projectName){
        this.elements.selectProject(projectName).click()
    }
...
module.exports = new ThirdPartyGridPage()