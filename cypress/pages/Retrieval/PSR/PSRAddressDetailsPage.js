...
class PSRAddressDetailsPage {comment
    elements = {
        ...
        // chaseIdCheckbox: (chaseIdCount) => cy.xpath("(//span[./text()='Chase ID']/following-sibling::app-chase-grid-chase-id)["+chaseIdCount+"]/parent::td/preceding-sibling::td/child::p-tablecheckbox"),
        ...
        clientdropdownlabel: () => cy.xpath("//li[@aria-label='Client']"),
        ...
        recentCommentBodyInTimeLine: () => cy.xpath("//app-timeline-detail-item//div[@class='chase-timeline-container chase-timeline-container__first']//div[2]//div[2]"), // getText
        recentCommentTimeStampInTimeLine: () => cy.xpath("//app-timeline-detail-item//div[@class='chase-timeline-container chase-timeline-container__first']//div[5]"), // getText
        ...
        submitbuttontouploadfile: () => cy.xpath("//app-file-upload//span[contains(text(),'Submit')]"),
        uploadfiletoastMessage: () => cy.get('.ui-toast-detail').contains("Thank you for uploading this medical record. We are now processing the file."),
        ...
        address1Columns: () => cy.xpath("//li[@aria-label='Address1']"),
        address2Columns: () => cy.xpath("//li[@aria-label='Address2']"),
        cityColumns: () => cy.xpath("//li[@aria-label='City']"),
        stateColumns: () => cy.xpath("//li[@aria-label='State']"),
        zipCodeColumns: () => cy.xpath("//li[@aria-label='Zip Code']"),
        phoneColumns: () => cy.xpath("//li[@aria-label='Phone']"),
        faxColumns: () => cy.xpath("//li[@aria-label='Fax']"),
        projectsColumns: () => cy.xpath("//li[@aria-label='Project(s)']"),
        addressGroupsColumns: () => cy.xpath("//li[@aria-label='Address Groups']"),
        ...
        totalChasesColumns: () => cy.xpath("//li[@aria-label='Total Chases']"),
        ...
        basicViewTotalChasesHeader: () => cy.xpath("//span[./text()='Total Chases']/parent::div[contains(@class,'header-container')]"),
        ...
        searchProviderButtonOnPopup: () => cy.xpath("//span[./text()='Search']/parent::button"), // click
        ...
        // Export 
        exportButtonPSRGrid: () => cy.xpath("//span[./text()='Export All']/parent::button"),
        exportButtonPSRUsers: () => cy.xpath("(//span[./text()='Export All']/parent::button)[1]"),
        ...
        citydata: () => cy.xpath("//app-info-item-template[1]//div[@class='info-item ng-star-inserted'][3]//div[2]"),
        statedata: () => cy.xpath("//app-info-item-template[1]//div[@class='info-item ng-star-inserted'][4]//div[2]"),
        zipdata: () => cy.xpath("//app-info-item-template[1]//div[@class='info-item ng-star-inserted'][5]//div[2]"),
        statusdata: () => cy.xpath("//app-info-item-template[1]//div[@class='info-item ng-star-inserted'][6]//div[2]"),
        groupnamedata: () => cy.xpath("//app-info-item-template[3]//div[@class='info-item ng-star-inserted'][4]//div[2]"),
        Phonedata: () => cy.xpath("//app-info-item-template[2]//div[@class='info-item ng-star-inserted'][2]//div[2]"),
        contactdata: () => cy.xpath("//app-info-item-template[2]//div[@class='info-item ng-star-inserted'][1]//div[2]"),
        faxdata: () => cy.xpath("//app-info-item-template[2]//div[@class='info-item ng-star-inserted'][3]//div[2]"),
        emaildata: () => cy.xpath("//app-info-item-template[2]//div[@class='info-item ng-star-inserted'][4]//div[2]"),
        preferredRequestMethoddata: () => cy.xpath("//app-info-item-template[2]//div[@class='info-item ng-star-inserted'][5]//div[2]"),
        ...
        aidstatuscolumn: () => cy.xpath("//tr//td[11]//span[2]"),
    ...
    clickOnExportAllButtonOnPSRGrid() {
        this.elements.exportButtonPSRGrid().click()
    }
    ...
    clickOnDropdownOptionForAllListBox(option) {
        //   this.elements.dropdownOptionForAllListBox
    ...
    verifyCurrentCommentAndTimeStampInTimeSpan(comment) {
        ...
        this.elements.recentCommentBodyInTimeLine().then(($obj) => {
            ...
            const newstr2 = str2
            cy.log(newstr2)
            expect(newstr2).to.equal(comment + " ")
    ...
    clickonSubmitbuttonToUploadfile() {
        this.elements.submitbuttontouploadfile().click()
        this.elements.uploadfiletoastMessage().should("be.visible")
    }
    ...
    clickOnCancelUploadedFile() {
        this.elements.cancelUploadedFile().click()
    }
    ...
    verifyToggleFunctionality() {
        ...
        this.elements.saveAsDefaultTeamViewToggleChecked().should("be.visible")
   ...
   veriyclickonusethisAddressbutton(){
    ...
    verifyviewthisaddress() {
        ...
        cy.wait(3000)
        this.elements.viewaddressbutton().click({ multiple: true })
    ...
    verifyclickoncontacthistoryTab() {
        this.elements.contacthistorytab().click()
    }
    verifyaddnote(note) {
...
module.exports = new PSRAddressDetailsPage()